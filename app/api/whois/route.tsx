...
export async function POST(request: Request) {
  try {
    ...
    if (Object.values(data).length === 1) {
      ...
      const contactAbuse = {
        Handle: data['contactAbuse']['OrgAbuseHandle'] || data['contactAbuse']['RAbuseHandle'],
        Name: data['contactAbuse']['OrgAbuseName'] || data['contactAbuse']['RAbuseName'],
        Phone: data['contactAbuse']['OrgAbusePhone'] || data['contactAbuse']['RAbusePhone'],
        Email: data['contactAbuse']['OrgAbuseEmail'] || data['contactAbuse']['RAbuseEmail'],
        Ref: data['contactAbuse']['OrgAbuseRef'] || data['contactAbuse']['RAbuseRef'],
      }
      const contactNoc = {
        Handle: data['contactNoc']['OrgNOCHandle'] || data['contactNoc']['RNOCHandle'],
        Name: data['contactNoc']['OrgNOCName'] || data['contactNoc']['RNOCName'],
        Phone: data['contactNoc']['OrgNOCPhone'] || data['contactNoc']['RNOCPhone'],
        Email: data['contactNoc']['OrgNOCEmail'] || data['contactNoc']['RNOCEmail'],
        Ref: data['contactNoc']['OrgNOCRef'] || data['contactNoc']['RNOCRef'],
      }
      const contactTechnical = {
        Handle: data['contactTechnical']['OrgTechHandle'] || data['contactTechnical']['RTechHandle'],
        Name: data['contactTechnical']['OrgTechName'] || data['contactTechnical']['RTechName'],
        Phone: data['contactTechnical']['OrgTechPhone'] || data['contactTechnical']['RTechPhone'],
        Email: data['contactTechnical']['OrgTechEmail'] || data['contactTechnical']['RTechEmail'],
        Ref: data['contactTechnical']['OrgTechRef'] || data['contactTechnical']['RTechRef'],
      }
